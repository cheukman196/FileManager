...
class MainView(QMainWindow):
    ...
    def init_tree_view(self, path=str(Path.home().as_posix())):
    ...
    def init_click_functions(self):
        ...
        self.back_button.clicked.connect(self.main_view_controller.directory_stack.visit_previous_page)
        self.next_button.clicked.connect(self.main_view_controller.directory_stack.visit_next_page)
        self.up_button.clicked.connect(self.main_view_controller.directory_stack.visit_parent_directory)
    ...
    def update_tree_view(self, tree_model, path=str(Path.home().as_posix())):
